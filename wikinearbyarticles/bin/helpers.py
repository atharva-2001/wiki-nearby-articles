...
class helpers():
    ...
    def plot_points(
        ...
        self.article_summary_for_hover(plot_index= plot_index, number_of_lines= number_of_lines)
        ...
        for x_coor,y_coor,z_coor,point in zip(coor[0], coor[1], coor[2], self.points): 
            fig.add_trace(go.Scatter3d(
            x = [x_coor,0],
            y = [y_coor,0],
            z = [z_coor,0],
